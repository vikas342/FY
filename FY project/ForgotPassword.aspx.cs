    ...
    protected void btnResetPass_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["MyShoppingDB"].ConnectionString))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody = "Hi ," + Username + ",<br/><br/>Click the link below to reset your password<br/> <br/> http://localhost:1138/MyEShoppingWebsite/RecoverPassword.aspx?id=" + myGUID;
                
                MailMessage PassRecMail = new MailMessage(" sender email write here", ToEmailAddress);
                ...
                using (SmtpClient client = new SmtpClient())
                {
                    ...
                    client.Credentials = new NetworkCredential("sender email write here ", " password write here");
