        ...
        <div class="container">
            ...
            <br />
                ...
                <div class ="form-group">
                    ...
                    <div class ="col-md-6">
                        <asp:Button ID="btnResetPass" CssClass ="btn btn-primary btn-lg" runat="server" Text="Send Recovery Link" OnClick="btnResetPass_Click" />
        ...
        <footer>
            <div class ="container ">
             <p class ="pull-right "><a href ="#">&nbsp; &nbsp; Back to top &nbsp; &nbsp;</a></p>
                ...
                <p>&copy;2020 Coderbaba.in &middot; <a href ="Default.aspx">Home</a>&middot;<a href ="Default.aspx">Products</a> </p>
            </div>
